...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  console.log('🧩 Widget Instances API called:', req.method, req.url);
  ...
  try {
    // Handle individual instance operations (/widgets/instances/{id})
    ...
    // Handle collection operations (/widgets/instances)
    if (req.method === 'GET') {
    ...
    console.error('💥 Widget Instances API error:', error);
